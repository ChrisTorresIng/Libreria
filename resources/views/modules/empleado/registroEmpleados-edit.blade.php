...
@section('titulo_principal', 'Registro Empleados | editar')
                ...
                <div class="container-fluid h-100 bg-violeta d-flex justify-content-center p-3 m-0 pt-lg-5 mb-3">
                    <div class="row w-100 d-flex justify-content-center">
                        <div class="col-12 col-md-11 col-lg-10">
                            <h2 class="text-dark text-center h4 text-capitalize fontNav">Editar de Empleados</h2>
                            @if (session('success'))
                                ...
                                <form action="{{ Route('empleados.update', $empleado->id) }}" method="post">
                                    ...
                                    <div class="form-group d-inline-block d-md-inline-block d-lg-flex">
                                        <label for="name" class="w-100 me-3">Nombre:
                                            <input type="text" name="nombre" id="nombre" placeholder="Ingrese..." value="{{  old('nombre', $empleado->nombre) }}" class="form-control w-100" maxlength="80">
                                        ...
                                        <label for="cedula" class="w-100">Cedula:
                                            <input type="text" name="cedula" id="cedula" placeholder="Ingrese..." value="{{ old('cedula', $empleado->cedula) }}" class="form-control w-100" maxlength="8">
                                            <span class="m-0 p-0 text-danger">
                                                @error('cedula')
                                                    {{ $message }}
                                                @enderror
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="correo">Correo Electrónico:
                                            <input type="email" name="correo" id="correo" placeholder="Ingrese..." value="{{ old('correo', $empleado->correo) }}" class="form-control" maxlength="100">
                                            <span class="m-0 p-0 text-danger">
                                                @error('correo')
                                                    {{ $message }}
                                                @enderror       
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <select name="trabajo" id="trabajo" class="form-select">
                                            <option value="{{ $empleado->trabajo }}"> Previa selección: {{ $empleado->trabajo}} </option>
