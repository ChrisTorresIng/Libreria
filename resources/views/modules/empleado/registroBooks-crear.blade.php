...
@section('titulo_principal', 'Registro Libros | crear')
                ...
                <div class="container-fluid h-100 bg-violeta d-flex justify-content-center p-3 m-0 pt-lg-5 mb-3">
                    <div class="row w-100 d-flex justify-content-center">
                        <div class="col-12 col-md-11 col-lg-12">
                            <h2 class="text-dark text-center h4 text-capitalize fontNav">Ingresar Libro</h2>
                            @if (session('success'))
                            ...
                            <div class="m-3 p-4 bg-light box-shawdow-black border-radius-5">
                                ...
                                <form action="{{ Route('books.store') }}" method="post">
                                    @csrf
                                    @method('POST')
                                    <div class="form-group d-inline-flex d-md-inline-block d-lg-flex w-100">
                                        <label for="title" class="w-100">titulo:
                                            <input type="text" name="title" id="title" placeholder="Ingrese..."
                                                class="form-control w-100" maxlength="120" value="{{ old('title') }}">
                                    ...
                                    <div class="form-group d-inline-flex d-md-inline-block d-lg-flex">
                                        <label for="author" class="w-100 me-3">Autor:
                                            <input type="text" name="autor" id="autor" placeholder="Ingrese..."
                                                class="form-control w-100" maxlength="30" value="{{ old('autor') }}">
                                            <span class="m-0 p-0 text-danger">
                                                @error('autor')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <label for="publication_year" class="w-100">Año publicación:
                                    ...
                                    <div class="form-group d-inline-block d-md-inline-block d-lg-flex">
                                        ...
                                        <label for="language" class="w-100 me-3">Idioma:
                                            <select name="language" id="language" class="form-select">
                                                ...
                                                <option value="Frances">Fr</option>
                                                <option value="Japones">Ja</option>
                                            </select>
                                            <span class="m-0 p-0 text-danger">
                                                @error('language')
                                                    {{ $message }}
                                    ...
                                    <div class="form-group mt-3 d-inline-flex d-md-flex d-lg-flex">
                                        <label for="clave" class="w-100">
                                            <textarea name="description" id="description" cols="80" rows="1" placeholder="Sinopsis" class="me-2 form-control-plaintext bg-white p-3">{{ old('description') }}</textarea>
                                            <span class="m-0 p-0 text-danger">
                                                @error('description')
                                                    {{ $message }}
                                                @enderror
                                    ...
                                    <div class="form-group mt-3 d-flex justify-content-center">
                                        <input type="submit" value="Registrar" class="btn btn-outline-verde w-50 p-2">
                                    </div>
